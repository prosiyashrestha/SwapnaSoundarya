  ...
  const services = [
    {
      ...
      price: "NRs 2000",
      description: [
        "Includes light makeup & eye makeup",
        "Includes brands like mac",
      ],
      image: "LightMakeup.jpg",
    },
    {
      title: "Party Makeup",
      price: "NRs 3000",
      description: [
        "Includes party makeup & eye makeup",
        "Includes brands like mac",
      ],
      image: "PartyMakeup.jpg",
    },
  ];
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>Makeup Services</h1>
      </div>
