  ...
  const services = [
    {
      ...
      price: "NRs 1000",
      description: [
        "Includes basic hairstyling of your choice",
        "Single low bun, straightening, fish braids, high pony",
      ],
      image: "BasicHairStyling.jpeg",
    },
    {
      title: "Advance Hair Styling",
      price: "NRs 1500",
      description: [
        "Includes advance hairstyling of your choice",
        "Single low bun, straightening, fish braids, high pony",
      ],
      image: "AdvanceHairStyling.jpg",
    },
  ];
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>Hair Styling Services</h1>
      </div>
