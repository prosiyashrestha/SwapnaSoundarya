...
const Keratin = () => {
  const services = [
    {
      title: "Short length Keratin",
      price: "NRs 3500",
      image: "ShortlengthKeratin.webp",
    },
    {
      title: "Mid length Keratin",
      price: "NRs 4500",
      image: "MidlengthKeratin.jpg",
    },
    {
      title: "Long length Keratin",
      price: "NRs 6000",
      image: "LonglengthKeratin.jpg",
    },
  ];
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>Keratin Services</h1>
      </div>
