...
const LashesExtension = () => {
  ...
  const services = [
    {
      title: "Classic Lashes Extension",
      category: "Lashes",
      subCategory: "Lashes Extension",
      price: "NRs 2000",
      description: ["Natural look with individual lash extensions"],
      image: "ClassicLashesExtension.webp",
    },
    {
      title: "Advanced Lashes Extension",
      category: "Lashes",
      subCategory: "Lashes Extension",
      price: "NRs 2400",
      description: ["Voluminous look with advanced lash techniques"],
      image: "AdvancedLashesExtension.png",
    },
  ];
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>Lashes Extension Services</h1>
      </div>
